...
def train_val_data_process():
    train_data = FashionMNIST(root='/data/ssd0/chenxiaolong/CNN/AlexNet_pytorch/data', train=True, transform=transforms.Compose([transforms.Resize(size=227), transforms.ToTensor()]), download=True)
...
def train_model_process(model, train_dataloader, val_dataloader, num_epochs):
    ...
    # 选择最优参数
    # 加载最高准确率下的模型参数
    torch.save(best_model_wts, '/data/ssd0/chenxiaolong/CNN/AlexNet_pytorch/best_model.pth')
